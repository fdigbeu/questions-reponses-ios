...
class VideosCell: UITableViewCell {
    @IBOutlet weak var labelVideosTitle: UILabel!
    @IBOutlet weak var labelVideosSubTitle: UILabel!
    ...
    func loadDataCell(titleValue:String, subTitleValue:String) -> VideosCell {
        self.labelVideosTitle.text = titleValue
        self.labelVideosSubTitle.text = subTitleValue
        self.imageVideo.image = #imageLiteral(resourceName: "video_64")
        // borderColor
