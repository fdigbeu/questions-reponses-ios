...
class GrowthSpiritCell: UITableViewCell {
    
    @IBOutlet weak var imageGrowth: UIImageView!
    @IBOutlet weak var labelGrowthTitle: UILabel!
    ...
    func loadDataCell(imageValue:UIImage, titleValue:String) -> GrowthSpiritCell {
        self.imageGrowth.image = imageValue
        self.labelGrowthTitle.text = titleValue
        // borderColor
